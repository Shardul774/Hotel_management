...
Public Class frmReserve
    ...
    Dim connectionString As String = "Data Source=(localdb)\ProjectModels;Initial Catalog=hotel;Integrated Security=True"
    ...
    Private Sub clear_text()
        ...
        ' This passes the actual Date object. The control handles the formatting automatically.
        dtCheckInDate.Value = time
        dtCheckOutDate.Value = Now.AddDays(1D)
    End Sub
        ...
        Else
            ...
            If a = vbYes Then
                ...
                Dim checkin As New SqlCommand("INSERT INTO tblTransaction(GuestID,RoomNum,CheckInDate,CheckOutDate,ReservationDate,NoOfChild,NoOfAdult,AdvancePayment,DiscountID,Remarks,Status) values ('" &
                                lblGuestID.Text & "','" &
                                txtRoomNumber.Text & "','" &
                                dtCheckInDate.Value.ToString("yyyy-MM-dd") & "','" &
                                dtCheckOutDate.Value.ToString("yyyy-MM-dd") & "','" &
